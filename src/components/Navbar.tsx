...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 h-1 bg-gradient-to-r from-green-400 to-blue-500" />
      
      {/* Main Navigation */}
      <nav className="fixed top-1 left-0 right-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm shadow-lg border-b border-gray-200 dark:border-gray-800">
