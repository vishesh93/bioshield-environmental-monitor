...
-- 5️⃣ Insert sample data into water_data
INSERT INTO water_data (station_id, ph, turbidity, lead, mercury, arsenic, hmpi)
VALUES
(1, 7.1, 2.5, 0.2, 0.01, 0.04, 0.35),
(2, 6.8, 3.1, 0.3, 0.02, 0.05, 0.45),
(3, 6.9, 2.8, 0.85, 0.12, 0.15, 0.65),
(4, 7.0, 3.2, 0.35, 0.06, 0.09, 0.48),
(5, 7.2, 1.8, 0.12, 0.02, 0.03, 0.25),
(6, 7.1, 2.1, 0.18, 0.03, 0.04, 0.32)
ON CONFLICT DO NOTHING;

-- 6️⃣ Insert sample data into alerts
